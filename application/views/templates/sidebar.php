...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
                <a href="<?php echo base_url('Form_Controller/type_centre') ?>">
                <i class="bi bi-circle"></i><span>Type de Centre</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/centre'); ?>">
                <i class="bi bi-circle"></i><span>Centre</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/unite_oeuvre'); ?>">
                <i class="bi bi-circle"></i><span>Unite d'Oeuvre</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/categorie_charge'); ?>">
                <i class="bi bi-circle"></i><span>Catégorie de Charge</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/type_charge'); ?>">
                <i class="bi bi-circle"></i><span>Type de Charge</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/nature_charge'); ?>">
                <i class="bi bi-circle"></i><span>Nature de Charge</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/rubrique_charge'); ?>">
                <i class="bi bi-circle"></i><span>Rubrique de Charge</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/charge'); ?>">
                <i class="bi bi-circle"></i><span>Charge</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/vente'); ?>">
                <i class="bi bi-circle"></i><span>Vente</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/production'); ?>">
                <i class="bi bi-circle"></i><span>Production</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/metier'); ?>">
                <i class="bi bi-circle"></i><span>Métier</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('Form_Controller/utilisateur'); ?>">
